...
public class TakesUpView extends JDialog {
    ...
    public TakesUpView(TakesMenu takesMenu){
        super(takesMenu,"更改takes",true);
        ...
        insertButton.addActionListener(e -> {
            ...
            boolean res = takes.update(takesDO);
            if(res){
                // 重新加载表格
