...
public class LessonInsertView extends JDialog {
    ...
    public LessonInsertView(LessonMenu lessonMenu){
        ...
        insertButton.addActionListener(e -> {
            ...
            boolean res = lesson.add(lessonDO);
    ...
    public static void main(String[] args) {
       ...
       new LessonInsertView(new LessonMenu());
    }
}
